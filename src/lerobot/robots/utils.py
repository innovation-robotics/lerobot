...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "microbot_follower":
        from .microbot_follower import MicrobotFollower

        return MicrobotFollower(config)
    elif config.type == "microbot_follower_end_effector":
        from .microbot_follower import MicrobotFollowerEndEffector

        return MicrobotFollowerEndEffector(config)
    elif config.type == "microbot_follower_ik":
        from .microbot_follower import MicrobotFollowerIK

        return MicrobotFollowerIK(config)
